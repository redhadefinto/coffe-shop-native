...
const EditPromo = () => {
  ...
  const handleUpdatePromo = async () => {
    try {
      ...
      console.log(error);
      // if(error.response.data.msg === 'Please Login Fir')
      showMessage({
                ...
                return (
                  <Fragment key={idx}>
                    ...
                    <View style={{marginBottom: 24, width: '100%'}}>
                      ...
                      <TextInput
                        style={[globalStyle.inputLine]}
                        value={discount || data.discount.toString() + '%'}
                        onChangeText={text => setDiscount(text)}
                        placeholder="Input the discount example 20%"
                        // placeholderTextColor={'black'}
                      />
                    </View>
                    ...
                    <View style={{marginBottom: 24, width: '100%'}}>
                      ...
                      <TouchableOpacity
                        ...
                        <Text style={styles.date}>{handleSelectedDate()}</Text>
                        <Image
                          source={iconCalender}
