  ...
  const handleCreateProduct = async () => {
    try {
      ...
      const data = {
        ...
        expired: selectedDate.toISOString().split('T')[0],
      };
      const result = await createProductWithPromo(
        {data, img: dataImage},
        controller,
        token,
      );
            ...
            {Loading ? (
              ...
              <>
                <View style={{position: 'relative'}}>
                  <Image source={handleSetImage()} style={styles.imageProd} />
                  <TouchableOpacity
