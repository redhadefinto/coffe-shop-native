...
const Chat = () => {
  ...
  const icon = require('../../assets/icon/icon-search.png');
  return (
    <NativeBaseProvider>
      <ScrollView flex={1}>
        <Box pt={10}>
          <Box px={7} flexDirection="row" alignItems="center" gap="130px">
            ...
            <Text color="#6A4029" fontWeight={700} fontSize="20px">
              Chat
            </Text>
          </Box>
          <VStack px={7} w="100%" alignSelf="center" mt={20}>
            <Input
              ...
              py="4"
              px="2"
              InputLeftElement={<Image source={icon} alt="menu" ml="7" />}
            />
          </VStack>
          <Text textAlign="center" mt="27px">
        ...
        <Box px={7} mb={5}>
          <Text fontWeight={700} fontSize="20px" mt="33px" mb="42px">
            Message
          </Text>
          <Box gap="20px">
            {dataChat?.map((item, idx) => (
