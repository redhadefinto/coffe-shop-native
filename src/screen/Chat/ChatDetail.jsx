...
const dataChating = [
  {
    admin:
      'Hey, welcome to Coffee Time!Today is Sunday and you know what? You will get a cup of coffee free only at 7 to 9 AM. If you still have some questions to ask, let me know. Have a wonderful day!',
  ...
  {
    admin:
      'Thank you for asking. Yup, you can request the beans, what beans do you like?',
    ...
    <NativeBaseProvider>
      ...
      <Box px={7} mb={10}>
        <Input
          ...
          InputRightElement={
            <Icon name="camera-outline" color="#000000" size={30} right={10} />
          }
        />
      </Box>
    </NativeBaseProvider>
